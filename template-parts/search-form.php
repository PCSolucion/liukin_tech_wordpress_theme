<div class="search-web">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-1">
                <a href="../" class="logow">
                    <img src="https://pc-solucion.es/wp-content/uploads/2025/02/favicon.png" width="55" height="122" alt="logo">
                </a>
            </div>
        
        <div class="col-lg-11">
                <form role="search" method="get" class="search-form2" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                    <button class="btn-search" aria-label="iconolupa" type="button">
